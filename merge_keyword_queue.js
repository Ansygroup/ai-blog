...
// Parse headSection as JSON array (it should be a valid JSON array because the file starts with '[' and then newline, then objects, then the HEAD marker)
