    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-16">
      <div className="text-center max-w-lg">
        ...
        <p className="text-slate-600 dark:text-dark-muted mb-8">
          We couldn't load this topic. It might not exist or the URL is incorrect.
        </p>
        <div className="flex flex-wrap gap-3 justify-center">
          ...
          <Link href="/topics" className="bg-white dark:bg-dark-card border border-slate-300 dark:border-dark-border hover:border-blue-500 dark:hover:border-blue-400 font-semibold px-5 py-2.5 rounded-lg transition">All Topics</Link>
