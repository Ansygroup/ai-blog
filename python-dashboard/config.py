...
AGENTS = [
    ...
    {"id": "social-agent", "name": "Social Agent", "category": "distribution", "desc": "Post to Twitter/X, LinkedIn, and Facebook via API", "emoji": "\U0001f4e2", "workflow": "social-agent.yml", "schedule": "On publish", "tier": "core"},
    {"id": "pinterest-agent", "name": "Pinterest Agent", "category": "distribution", "desc": "Create Pinterest pins from new posts via API v5", "emoji": "\U0001f4cc", "workflow": "pinterest-agent.yml", "schedule": "On publish", "tier": "support"},
    ...
    {"id": "content-performance", "name": "Content Performance", "category": "intelligence", "desc": "Analyze posts, classify, generate Groq recommendations to boost traffic", "emoji": "\U0001f4c8", "workflow": "content-performance.yml", "schedule": "Weekly Sun", "tier": "support"},
