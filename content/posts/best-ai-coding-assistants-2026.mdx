...
**What we liked:** Actually free, no "trial" asterisk. Windsurf (its IDE [product](/posts/ai-ecommerce-product-recommendation-engine-optimization)) has surprisingly good repo-wide search. Self-hostable enterprise version.
