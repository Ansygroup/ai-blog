...
---
title: "<SEO title, 50-60 chars, primary keyword in first 5 words>"
slug: "<auto-generated>"
excerpt: "<150-160 char meta description with primary keyword + emotional hook>"
description: "<same as excerpt for OG tags>"
date: "<YYYY-MM-DD>"
...
<2-3 sentence hook paragraph that includes primary keyword in first sentence. Speak directly to reader.>

<div class="key-takeaways">

## Key Takeaways

- <3-5 bullet summary points — these get pulled by AI engines as "TL;DR">

</div>

## Quick Answer (for AI snippets)

<2-3 sentence direct answer optimized to be quoted by ChatGPT/Perplexity. Start with the recommendation, not background.>

## What Is <Primary Keyword>?

<Define the topic concisely. 2-3 paragraphs. Use the primary keyword 2-3 times naturally.>

## How We Test (E-E-A-T signals)

<Explain methodology in 1 short paragraph — this builds trust signals for both Google and AI engines.>

<main H2 sections — 5 to 8 of them, each 200-400 words>
...
<Realistic pricing table. AI engines LOVE structured pricing info.>

## Who Should Use <Tool>?

<2-3 short user personas.>

## Who Should NOT Use <Tool>?
...
<Direct 2-3 sentence answer — quoted in AI Overviews>
